...
function  mainChange() {
 ...
 if(count==4){
   a = 13000;
   (new Audio("効果音/s5-2.mp3")).play();
   setTimeout('(new Audio("音声/s5.mp3")).play();', 10000);
 } 

 if(count==5){
   a =10000;
   (new Audio("効果音/s6-2.mp3")).play();
   setTimeout('(new Audio("音声/s6.mp3")).play();', 5000);
 } 
 if(count==6){
  a = 17000;
  (new Audio("効果音/s7-2.mp3")).play();
 ...
 if(count==7){   
   ...
   (new Audio("効果音/s8-2.mp3")).play();
    setTimeout('(new Audio("音声/s8.mp3")).play();', 5000);
 } 
 
 if(count==8){
  (new Audio("効果音/s9-2.mp3")).play();
